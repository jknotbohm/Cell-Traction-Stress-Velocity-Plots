...
%         v_cell_k = v_cell_k - nanmedian(v_cell_k(:));
    ...
    quiver(x_cell2,y_cell2,u_cell_k2,v_cell_k2,'color','c','linewidth',1.25);
    caxis([0 max_vel]); colormap(gca,'hot'); colorbar;
    axis xy; axis equal; axis tight; set(gca,'box','off');
    if pix_size == 1
            xlabel('pix'); ylabel('pix');
        else
    ...
    caxis([-max_vel max_vel]); colormap(cmap); colorbar;
    axis xy; axis equal; axis tight; set(gca,'box','off');
    if pix_size == 1
            xlabel('pix'); ylabel('pix');
        else
    ...
    % OPTIONAL: radial and angular compoents of velocity
%     % Radial velocity
%     subplot(2,3,5);
%     
